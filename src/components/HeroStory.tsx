  ...
  return (
    <div
      ...
      style={{
        width: "min(320px, 60%)",
        height: 1,
        backgroundColor: "hsl(var(--dossier-brass) / 0.4)",
      }}
    >
      <span
        style={{
...
const INTRO_FLAG = "dossier-hero-intro-played-v2";
          ...
          >
            ...
            >
              {[
                ...
                >
                  YOU <span style={{ color: "hsl(var(--dossier-brass))" }}>{verb}</span> {rest}
                </p>
              ))}
            </div>
        ...
        >
          <div className="dossier-navy-pane w-full flex flex-col items-center gap-3 px-4 py-4 sm:px-8 sm:py-5 md:px-16">
            ...
            <a
              ...
              className="dossier-cta-brass pointer-events-auto inline-flex items-center gap-2 font-sans"
              style={{
                backgroundColor: "hsl(var(--dossier-brass))",
                color: "hsl(var(--dossier-ink-deep))",
                padding: "12px 22px",
      ...
      >
        ...
        >
          ...
          <section className="mx-auto w-full max-w-5xl py-16 lg:py-24">
            ...
            <p
              className="font-sans text-dossier-charcoal"
          ...
          <div className="mx-auto w-full max-w-5xl px-6 py-16 sm:px-8 md:px-12 lg:py-24 lg:px-16">
            <div
              ...
              style={{
                fontSize: 11,
                letterSpacing: "0.22em",
                color: "hsl(var(--dossier-paper) / 0.7)",
                textTransform: "uppercase",
                marginBottom: 16,
              }}
            >
        ...
        <section className="mx-auto w-full max-w-5xl py-16 lg:py-24">
          ...
          <div style={{ borderTop: "1px solid hsl(var(--dossier-paper-edge))" }} />
          <div className="mt-10 flex justify-start">
            <a
              href="/consult"
              onClick={() => track("consult_cta_click", "/hero-story")}
              className="dossier-cta-brass group inline-flex items-center gap-2 font-sans"
              style={{
                backgroundColor: "hsl(var(--dossier-brass))",
                color: "hsl(var(--dossier-ink-deep))",
                padding: "14px 26px",
