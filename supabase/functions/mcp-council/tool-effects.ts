...
export const EFFECTS_CATALOG_VERSION = "pkt0a.1";
...
export const TOOL_EFFECTS: Readonly<Record<string, readonly Effect[]>> = Object.freeze({
  ...
  load_kernel_part: ["identity_read"],
  begin_session: ["projection_read", "projection_write", "telemetry_write"],
  save_session: ["canonical_write", "projection_write", "telemetry_write"],
  sync_session: ["canonical_read", "projection_write", "telemetry_write"],
  end_session: ["canonical_write", "projection_write", "telemetry_write"],
  show_council: ["config_read"],
  convene_council: ["model_invocation", "telemetry_write"],
  summon_best_advisor: ["model_invocation", "telemetry_write"],
  abe_weighing_in: ["model_invocation"],
  file_to_office: ["model_invocation", "canonical_write", "telemetry_write"],
  welcome_party: ["onboarding_read", "onboarding_write"],
  taylor_setup: ["onboarding_read", "onboarding_write"],
  record_intake: ["onboarding_write"],
  set_chief_name: ["config_write", "onboarding_write"],
  setup_progress: ["onboarding_write"],
});
